...
jette.photo.attach(io: File.open('app/assets/images/theresa.jpg'), filename: 'theresa.jpg', content_type: 'image/jpg')
...
ziggy1192.photo.attach(io: File.open('app/assets/images/theresa.jpg'), filename: 'theresa.jpg', content_type: 'image/jpg')
